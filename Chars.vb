...
Public Class Chars
    ...
    Public Shared Function ToInt(c As Char) As Integer

        Return Convert.ToInt32(c)
    End Function

    Public Shared Function ToChar(c As Integer) As Char

        Return ToChar(Convert.ToUInt32(c))
    End Function

    Public Shared Function ToChar(c As UInteger) As Char

        Return Convert.ToChar(c)
    End Function

    Public Shared Function Min(a As Char, b As Char) As Char

        If a < b Then Return a
        Return b
    End Function

    Public Shared Function Max(a As Char, b As Char) As Char

        If a < b Then Return b
        Return a
    End Function

    Public Shared Function Add(c As Char, inc As Integer) As Char
